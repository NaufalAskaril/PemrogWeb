...
<!-- Pada code di atas merupakan oop dari class Animal yang di inheritance ke class Cat dan Dog, 
kemudian pada class Animal memiliki function __construct($name) untuk inisialisasi nama hewan, 
kemudian pada class Cat menggunakan function meow() untuk membuat suara meong, dan pada class Dog menggunakan function bark() untuk membuat suara gonggongm, kemudian memanggil 
method. -->